...
subtitle: GA and ANN Pima Diabetes
runtime: shiny
output: 
  html_document:
    theme: cosmo
...
wdDataset <- "E:/Documentos/Maestría en Sistemas Computacionales/Nueva Tesis/DataSet/Diabetes/Pima Indians Diabetes/"
...
wdModelosANN <- "E:/Documentos/Maestría en Sistemas Computacionales/Nueva Tesis/Experimentos/04--08-Dic-17/Modelos/ANN Pima Diabetes/"
```
...
##Datos perdidos
Los datos perdidos se respresentann con 0
```{r datosPerdidos}
# #Glucosa
# pos <- which((dataset$Plasma.glucose.concentration==0)==T)
# dataset <- dataset[-pos,]
# #Body.mass.index
# pos <- which((dataset$Body.mass.index==0)==T)
# dataset <- dataset[-pos,]
# #Triceps.skin.fold.thickness
# pos <- which((dataset$Triceps.skin.fold.thickness==0)==T)
# dataset <- dataset[-pos,]
# # Diastolic.blood.pressure
# a <- 1
# for(i in 1:nrow(dataset)){
#   if(dataset$Diastolic.blood.pressure[i]==0){
#     cat(a, "\n")
#     a <- a+1
#   }
# }
...
write.csv(x = dataset,file = "pima-indians-diabetes.csv", row.names = F)
```
...
### Normalizar Heart Diseases dataset
...
evalFunc <- function(x) {
  ...
  cat("\ncalificación ", round(resANN$exactitud, 4),"\n" )
...
saveRDS(object = GAmodel, "GAmodel 1.rds")
```
